...
const icons = {
  ...
  video: (
    <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
      <rect x="2" y="4" width="20" height="16" rx="2" /><path d="m10 9 5 3-5 3z" fill="currentColor" />
    </svg>
  ),
  play: (
    <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
...
export default function QRTypeTabs({ activeType, onChange }) {
  return (
    <div style={{
      display: 'flex',
      flexWrap: 'wrap',
        ...
        return (
          <button
            ...
            style={{
              ...
              background: isActive ? 'rgba(196, 112, 70, 0.15)' : 'var(--bg-primary)',
